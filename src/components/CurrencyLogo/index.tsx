...
export const getTokenLogoURL = (address: string) => {
  let uri;
  if (address?.toLowerCase() === '0xCA63D9208E3a40E6Ff0eAfFDcf01daf885612CF3'.toLowerCase()) {
    uri = 'https://ipfs.io/ipfs/QmaVGccs1Koz8UPUELrLoAwWdGMSL1QDe9nQ1zHShGe7Cj'
  }
  if (address?.toLowerCase() === '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270'.toLowerCase()) {
    uri = 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum/assets/0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0/logo.png'
  }
