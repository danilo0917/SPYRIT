...
import { Code,BookOpen, MessageCircle } from 'react-feather'
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          ...
          <MenuItem id="link" href="https://t.me/spyritcoin">
            <MessageCircle size={14} />
            Telegram
          </MenuItem>
          <MenuItem id="link" href="https://Twitter.com/spyritcoin">
            <MessageCircle size={14} />
            Twitter
          </MenuItem>
          <MenuItem id="link" href="https://discord.com/invite/xzyeMr3Rbb">
            <BookOpen size={14} />
            Discord
          </MenuItem>
          <MenuItem id="link" href="https://github.com/spyritcoin">
            <Code size={14} />
            GitHub
          </MenuItem>
          {/* {account && (
