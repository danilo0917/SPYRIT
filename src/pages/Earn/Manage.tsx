    ...
    <PageWrapper gap="lg" justify="center">
      ...
      {showAddLiquidityButton && (
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Step 1. Get {(stakingInfo?.name && stakingInfo?.name !== "" ? stakingInfo.name : "Uniswap V2")} Liquidity tokens</TYPE.white>
              </RowBetween>
              <RowBetween style={{ marginBottom: '1rem' }}>
                <TYPE.white fontSize={14}>
                  {(stakingInfo?.name && stakingInfo?.name !== "" ? stakingInfo.name : "Uniswap V2") + " tokens are required. Once you've added liquidity to the " + currencyA?.symbol + "-" + currency2?.symbol + " pool you can stake your liquidity tokens " + (stakingInfo?.lp && stakingInfo?.lp !== "" ? " " : " ")}
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
                  ...
                  <TYPE.white>
                    {
                      stakingInfo?.isNftToken ?
                        ...
                        !stakingInfo?.isTokenOnly ?
                          <>
                            {stakingInfo?.name && stakingInfo?.name && stakingInfo.name !== '' ? stakingInfo.name : 'Uniswap V2 ' + ((currencyA?.symbol !== undefined ? currencyA?.symbol : '') + '-' + (currencyB?.symbol !== undefined ? currencyB?.symbol : ''))}
            ...
            {stakingInfo?.name !== 'vault' ?
              <>
                ...
                <AutoColumn gap="sm">
                  <RowBetween>
                    <div>
                      <TYPE.black>Your unclaimed SPYRIT</TYPE.black>
                    </div>
              ...
              <>
                ...
                <AutoColumn gap="sm">
                  <RowBetween>
                    <div>
                      <TYPE.black>Recent Spyrit profit</TYPE.black>
                    </div>
                    {stakingInfo?.earnedAmount && JSBI.notEqual(BIG_INT_ZERO, stakingInfo?.earnedAmount?.raw) && (
                      <ButtonEmpty
                        padding="8px"
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : (
          !stakingInfo?.isNftToken ?
          <TYPE.main>{userLiquidityUnstaked.toSignificant(6)} {stakingInfo?.name !== '' ? stakingInfo?.name == 'vault' ?'SPYRIT':stakingInfo?.name: 'Uniswap V2 LP'} tokens available</TYPE.main>
          :
          <></>
        )}
      </PositionInfo>
