  ...
  return (
    <ContentWrapper gap="lg">
      <ModalUpper>
        ...
        <CardSection gap="md">
          <RowBetween>
            <TYPE.white color="white">Your SPYRIT Breakdown</TYPE.white>
        ...
        <CardSection gap="sm">
          <AutoColumn gap="md">
            ...
            {uni && uni.chainId === ChainId.MATIC ? (
              <ExternalLink href={`https://dexscreener.com/polygon/0xbc635b3ee4b0968fe748b32a5c470b456d7472c1`}>View SPYRIT Analytics</ExternalLink>
            ) : null}
          </AutoColumn>
        </CardSection>
      </ModalUpper>
