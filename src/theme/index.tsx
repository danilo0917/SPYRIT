...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    text2: darkMode ? '#C3C5CB' : 'rgba(255, 255, 255, 0.5)',
    ...
    //primary colors
    //autonio ui change 27-02-2021
    primary1: darkMode ? '#D700FF' : '#D700FF',
    primary2: darkMode ? '#3680E7' : '#FF8CC3',
    primary3: darkMode ? '#4D8FEA' : '#FF99C9',
    primary4: darkMode ? '#376bad70' : '#F6DDE8',
    //autonio ui change 27-02-2021
    primary5: darkMode ? '#540581' : '#540581',
...
html, input, textarea, button {
  ...
  @font-face{
    font-family: 'bicubik';
    src: url('/fonts/bicubik-webfont.woff')format('woff');
  }
}
